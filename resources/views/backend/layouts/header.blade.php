          ...
          <div class="main-sidebar sidebar-style-2">
              <aside id="sidebar-wrapper">
                  <div class="sidebar-brand">
                      <a href="index.html"> <img alt="image" src={{ url('backend/img/logo.png') }}
                  ...
                  <ul class="sidebar-menu">
                      ...
                      <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                              <li><a class="nav-link" href="{{ url('admin/banner/') }}">all banner</a>
                              </li>
                              <li><a class="nav-link" href="{{ url('admin/banner/create/') }}">add
                                      banner</a></li>
                          </ul>
                      </li>
                      <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                              <li><a class="nav-link" href="{{ url('/admin/auth/register') }}">Add
                                      User</a>
                              </li>
                              <li><a class="nav-link" href="{{ url('/admin/users') }}">All User</a>
                              </li>
                          </ul>
                      </li>
                      <li class="dropdown">
