              ...
              <nav class="navbar navbar-expand-lg main-navbar sticky">
                ...
                <ul class="navbar-nav navbar-right">
                  ...
                  <li class="dropdown"><a href="#" data-toggle="dropdown"
                      class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src={{ url('backend/img/user.png')}}
                    ...
                    <a href="{{ route('admin.profile')}}" class="dropdown-item has-icon"> <i class="far
                      ...
                      <a href={{ url('/admin/auth/logout')}} class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
                        Logout
                      </a>
                    </div>
                  </li>
              ...
              <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                  <div class="sidebar-brand">
                    <a href="index.html"> <img alt="image" src={{ url('backend/img/logo.png')}} class="header-logo" /> <span
                  ...
                  <ul class="sidebar-menu">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="nav-link" href="{{ url('admin/banner/')}}">all banner</a></li>
                        <li><a class="nav-link" href="{{ url('admin/banner/create/')}}">add banner</a></li>
                      </ul>
                    </li>
                    <li class="dropdown">
                      <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="users"></i><span>Users</span></a>
                      <ul class="dropdown-menu">
                      <li><a class="nav-link" href="{{url('/admin/auth/register')}}">Add User</a></li>
                      <li><a class="nav-link" href="{{url('/admin/users')}}">All User</a></li>
                      </ul>
                    </li>
                    <li class="dropdown">
