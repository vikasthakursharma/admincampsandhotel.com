 <!DOCTYPE html>
        ...
        <head>
          ...
          <link rel='shortcut icon' type='image/x-icon' href=<?php echo e(url('backend/img/favicon.ico')); ?>/>
        </head>
              ...
              <nav class="navbar navbar-expand-lg main-navbar sticky">
                ...
                <ul class="navbar-nav navbar-right">
                  ...
                  <li class="dropdown"><a href="#" data-toggle="dropdown"
                      class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src=<?php echo e(url('backend/img/user.png')); ?>

                        class="user-img-radious-style"> <span class="d-sm-none d-lg-inline-block"></span></a>
                    <div class="dropdown-menu dropdown-menu-right pullDown">
                      <div class="dropdown-title">Hello <?php echo e(session('admin_name')); ?></div>
                      ...
                      <a href=<?php echo e(url('/admin/auth/logout')); ?> class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
                        Logout
                      </a>
                    </div>
                  </li>
              ...
              <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                  <div class="sidebar-brand">
                    <a href="index.html"> <img alt="image" src=<?php echo e(url('backend/img/logo.png')); ?> class="header-logo" /> <span
                  ...
                  <ul class="sidebar-menu">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="nav-link" href="<?php echo e(url('admin/banner/')); ?>">all banner</a></li>
                        <li><a class="nav-link" href="<?php echo e(url('admin/banner/create/')); ?>">add banner</a></li>
                      </ul>
                    </li>
                    <li class="dropdown">
                      <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="users"></i><span>Users</span></a>
                      <ul class="dropdown-menu">
                      <li><a class="nav-link" href="<?php echo e(url('/admin/auth/register')); ?>">Add User</a></li>
                      <li><a class="nav-link" href="<?php echo e(url('/admin/users')); ?>">All User</a></li>
                      </ul>
                    </li>
                    <li class="dropdown">
...
<?php /**PATH C:\xampp\htdocs\admincampsandhotel.com\resources\views/backend/layouts/header.blade.php ENDPATH**/ ?>