                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    : activate to sort column descending" style="width: 24.4375px;">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $banner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allbanner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr role="row" class="odd">
                                                                <td class="sorting_1">
                                                                    <?php echo e($allbanner->id); ?>

                                                                </td>
                                                                <td> <?php echo e($allbanner->tagline); ?></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ?>
                                                                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imgSrc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <img src="<?php echo e(asset('/storage/images/' . $imgSrc)); ?>"
                                                                            alt="<?php echo e($imgSrc); ?>" class="img img-thumbnail">
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo e(url('/admin/banner/create/')); ?>"
                                                                        class="btn btn-success btn-sm">Add</a>
                                                                    <a href="<?php echo e(url('/admin/banner/edit/' . $allbanner->id)); ?>"
                                                                        class="btn btn-warning btn-sm">Edit</a>
                                                                    <a href="<?php echo e(url('/admin/banner/delete/' . $allbanner->id)); ?>"
...
<?php echo $__env->make('backend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admincampsandhotel.com\resources\views/backend/view-banner.blade.php ENDPATH**/ ?>